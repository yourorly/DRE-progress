...
<?php if (isset($user)): ?>
    ...
    <button class="btn btn-light btn-sm" style="padding: 15px;"><a href="../Dash/add_category.php" style="text-decoration: none; color: black; font-weight: bold;">Add Category</a></button>
    ...
    <div class="container">
      <table>
        <tr>
          ...
          <?php
          $sqlc = "SELECT * FROM drecategorydb";
          ...
          if($count>0){
            while($row=mysqli_fetch_assoc($resultc)){
              ...
              <tr>
                ...
                <td>
                  <a href="edit_category.php?id=<?php echo $id;?>">Edit</a>
                  <a href="delete_category.php?id=<?php echo $id;?>">Delete</a>
                </td>
              </tr>
              </tr>
              <?php
