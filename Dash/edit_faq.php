...
<?php if (isset($user)): ?>
    ...
    <div class="container-fluid manage-items main">
      <div class="glass-filter">
        <br><br>
      <p class="h1">Manage Home | Edit FAQ</p>
      ...
      if (isset($_GET['id'])){
        $id = $_GET['id'];
        $sqlt = "SELECT * FROM faqdb WHERE id = $id";
      ...
      <form action="" method="post" enctype="multipart/form-data">
        <table>
          <tr>
            <td>FAQ Name : </td>
            <td><input type="text" name="title" id="pname" placeholder="Title" value="<?php echo $title;?>" required></td>
          ...
          <tr>
            ...
            <td><button><a href="manage_faq.php" class="btn-secondary">Cancel</a></button></td>
          </tr>
        </table>
      </form>
      </div>
    ...
    if (isset($_POST['submit'])){
      ...
      if ($res2 == true){
        $_SESSION['add'] = "<div class='alert alert-success'><strong>Success!</strong> FAQ Updated.</div>";
        header('location:'.SITEURL.'manage_faq.php');
      }else{
        $_SESSION['add'] = "<div class='alert alert-danger'><strong>Error!</strong> Failed to edit FAQ.</div>";
        header('location:'.SITEURL.'manage_faq.php');
      }
    }
    ?>
