    ...
    <div class="container-fluid manage-items main">
      <div class="glass-filter">
        ...
        if(isset($_GET['id'])){
          ...
          $current_bestsell = $count2['bestseller'];
        }
        ?>
      <p class="h1">Manage Menu | Edit Food</p>
      <form action="" method="post" enctype="multipart/form-data">
        <table>
          <tr>
            <td>Food Name : </td>
            <td><input type="text" name="productname" id="pname" placeholder="Name Of The Item" value="<?php echo $current_title;?>" required></td>
          ...
          <tr>
            <td>Best Seller : </td>
            <td>
              <input <?php if($current_bestsell=="Yes"){echo "Checked"; }?> type="radio" name="bestsell" id="Yes" value="Yes">Yes
              <input <?php if($current_bestsell=="No"){echo "Checked"; }?> type="radio" name="bestsell" id="No" value="No">No
            </td>
          </tr>
        ...
        if(isset($_POST['submit']))
        {
          ...
          $sql3 = "UPDATE drefooddb SET title='$title', description='$description', price='$price', image_name='$image_name', category_id='$category', featured='$featured', bestseller='$bestseller', active='$active' WHERE id=$id";
